    ...
    return (
        ...
        md:items-center md:justify-center">
            ...
            <img
                ...
                className="absolute -z-10 !hidden opacity-60 sm:!inline w-full h-full object-cover"
            />
            <img
            ...
            <form onSubmit={handleSubmit(onSubmit)}
                  className='relative mt-24 space-y-8 rounded bg-black/75 py-10 px-5 md:mt-0
